...
namespace SGTD_WebApi.Migrations
{
    ...
    [Migration("20250629212426_AddDocumentaryProcessEntities")]
    partial class AddDocumentaryProcessEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.DocumentaryProcessDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DocumentaryProcessInstanceId")
                        .HasColumnType("integer");

                    b.Property<int?>("DocumentaryProcessStepInstanceId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DocumentaryProcessInstanceId");

                    b.HasIndex("DocumentaryProcessStepInstanceId");

                    b.HasIndex("UploadedByUserId");

                    b.ToTable("DocumentaryProcessDocuments");
                });

            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.DocumentaryProcessInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DocumentaryProcessInstances");
                });

            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.DocumentaryProcessNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DocumentaryProcessNotifications");
                });

            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.DocumentaryProcessStepInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DocumentaryProcessStepInstances");
                });
            ...
            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.UserFileShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.DocumentaryProcessDocument", b =>
                {
                    ...
                    b.HasOne("SGTD_WebApi.DbModels.Entities.DocumentaryProcessInstance", "DocumentaryProcessInstance")
                        .WithMany("Documents")
                        .HasForeignKey("DocumentaryProcessInstanceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SGTD_WebApi.DbModels.Entities.DocumentaryProcessStepInstance", "DocumentaryProcessStepInstance")
                        .WithMany("Documents")
                        .HasForeignKey("DocumentaryProcessStepInstanceId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SGTD_WebApi.DbModels.Entities.User", "UploadedByUser")
                        .WithMany()
                    ...
                    b.Navigation("DocumentaryProcessInstance");

                    b.Navigation("DocumentaryProcessStepInstance");
            ...
            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.DocumentaryProcessInstance", b =>
                {
                    ...
                    b.HasOne("SGTD_WebApi.DbModels.Entities.User", "RequestedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.DocumentaryProcessStepInstance", b =>
                {
                    b.HasOne("SGTD_WebApi.DbModels.Entities.User", "AssignedToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SGTD_WebApi.DbModels.Entities.UserFileShare", b =>
                {
                    b.HasOne("SGTD_WebApi.DbModels.Entities.User", "SharedByUser")
                        .WithMany()
                        .HasForeignKey("SharedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SGTD_WebApi.DbModels.Entities.User", "SharedWithUser")
                        .WithMany()
                        .HasForeignKey("SharedWithUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SGTD_WebApi.DbModels.Entities.UserFile", "UserFile")
                        .WithMany()
